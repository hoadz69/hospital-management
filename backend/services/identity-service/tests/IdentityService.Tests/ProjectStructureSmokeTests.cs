...
/// <summary>
/// Smoke test tối thiểu xác nhận project references và assembly identity của Identity Service
...
{
    /// <summary>
    /// Đảm bảo Domain assembly của Identity Service load được trong test host và trỏ đúng marker
    ...
    public void AssemblyHasExpectedNamespace()
    {
        ...
        Assert.Equal("IdentityService.Domain", domainName);
    }
}
