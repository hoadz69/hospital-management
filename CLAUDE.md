...
This project is indexed by GitNexus as **hospital-management** (2647 symbols, 4988 relationships, 173 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/hospital-management/context` | Codebase overview, check index freshness |
| `gitnexus://repo/hospital-management/clusters` | All functional areas |
| `gitnexus://repo/hospital-management/processes` | All execution flows |
| `gitnexus://repo/hospital-management/process/{name}` | Step-by-step execution trace |
